...
def parse_cpp_datatype(var_die):
    ...
    while type_die.tag in ('DW_TAG_volatile_type', 'DW_TAG_const_type', 'DW_TAG_pointer_type', 'DW_TAG_reference_type'):
        modifier = _strip_type_tag(type_die) # volatile/const/reference/pointer
